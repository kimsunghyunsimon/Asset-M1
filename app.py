...
default_data = pd.DataFrame([
    {"종목코드": "005930.KS", "수량": 100},  # 1. 삼성전자
    {"종목코드": "000660.KS", "수량": 50},   # 2. SK하이닉스
    {"종목코드": "005380.KS", "수량": 30},   # 3. 현대차
    {"종목코드": "005490.KS", "수량": 20},   # 4. POSCO홀딩스
    {"종목코드": "035420.KS", "수량": 15},   # 5. NAVER
    {"종목코드": "AAPL", "수량": 10},        # 6. 애플 (미국)
    {"종목코드": "TSLA", "수량": 10},        # 7. 테슬라 (미국)
    {"종목코드": "NVDA", "수량": 5},         # 8. 엔비디아 (미국)
    {"종목코드": "MSFT", "수량": 5},         # 9. 마이크로소프트 (미국)
    {"종목코드": "QQQ", "수량": 20}          # 10. 나스닥 ETF (미국)
   ])
